...
public class ColorArcProgressBar extends View {
    ...
    public String getCurrentValue(String curValues) {
        return curValues;
    }
    ...
    private void setAnimation(float last, final float current, int length) {
        ...
        progressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                Log.d("currentAngle","currentAngle"+currentAngle);
                    for (ViewWasTouchedListener listener:listeners){
                        listener.onViewTouched(String.valueOf(currentAngle));
                    }
    ...
    public interface ViewWasTouchedListener {
        void onViewTouched(String value);
    }
}
